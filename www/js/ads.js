...
alert("ads starts");
    ...
    await loadNativeAd("#nativeAdIndex", "ca-app-pub-3940256099942544/2247696110");
    await loadNativeAd("#nativeAdMenu", "ca-app-pub-3940256099942544/2247696110");
    await loadNativeAd("#nativeAdQuiz", "ca-app-pub-3940256099942544/2247696110");
...
async function showInterstitial() {
  try {
    ...
    console.warn("Interstitial not ready, loading now...");
    await loadInterstitial();
  }
}
